/*
 * fork from https://github.com/ARMmbed/mbedtls/blob/development/programs/ssl/ssl_client2.c
 * */
...
#define DFL_CA_FILE             CERT_PATH"ca.crt"
#define DFL_CA_PATH             ""
#define DFL_CRT_FILE            CERT_PATH"client.crt"
#define DFL_KEY_FILE            CERT_PATH"client.key"

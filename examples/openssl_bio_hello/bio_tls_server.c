/*
 * Fork from https://github.com/darrenjs/openssl_examples.git
 * */
...
int main(int argc, char **argv)
{
    ...
    int enable = 1;
    if (setsockopt(servfd, SOL_SOCKET, SO_REUSEADDR, &enable, sizeof(enable))
            < 0)
    ...
    ssl_init(CERT_PATH"server.crt", CERT_PATH"server.key");
    ...
    while (1) {
        ...
        inet_ntop(peeraddr.sin_family, &peeraddr.sin_addr, str,
                INET_ADDRSTRLEN);
